...
worksheet.write('A2', '諸度股份有限公司 工時紀錄   民國 ' + str(year - 1911) + ' 年 ' + str(month) + ' 月份     員工：   ', bold)
...
for index, day in enumerate(days):
    worksheet.write(("A" if index < 16 else "H") + str(index % 16 + 4), day['day'])
    worksheet.write(("B" if index < 16 else "H") + str(index % 16 + 4), weekday(day['weekday']))
